            ...
            modelBuilder.Entity("BilgeHotel.Entities.ComplexType.ReservationDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationId = new Guid("06f3f8a3-5a48-4e3b-81c0-5c2ef8db86e0"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("e817e22c-ea7c-4e8d-b7a6-f726311e840a"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 21, 4, 10, 488, DateTimeKind.Local).AddTicks(4542),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("02e342f1-e2b4-42db-ab7a-8aba67e84338"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("e817e22c-ea7c-4e8d-b7a6-f726311e840a"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 21, 4, 10, 488, DateTimeKind.Local).AddTicks(7128),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("d92862d4-cea1-4775-8689-6f00033a43c3"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("e817e22c-ea7c-4e8d-b7a6-f726311e840a"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 21, 4, 10, 488, DateTimeKind.Local).AddTicks(7136),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("0ae3674c-815a-4d2f-aafb-3a991dea6148"),
                            PackageId = 1,
                            RoomId = 102,
                            CardId = new Guid("e817e22c-ea7c-4e8d-b7a6-f726311e840a"),
                            CheckInDate = new DateTime(2022, 3, 6, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckOutDate = new DateTime(2022, 3, 7, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2022, 3, 6, 21, 4, 10, 488, DateTimeKind.Local).AddTicks(7141),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e817e22c-ea7c-4e8d-b7a6-f726311e840a"),
                            CardNumber = "selam",
                            CardType = "Ziraat",
                            Cv2 = "ABC",
                            EndDate = "02/05"
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06f3f8a3-5a48-4e3b-81c0-5c2ef8db86e0"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("02e342f1-e2b4-42db-ab7a-8aba67e84338"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("d92862d4-cea1-4775-8689-6f00033a43c3"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("0ae3674c-815a-4d2f-aafb-3a991dea6148"),
                            CustomerId = 1
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Shift", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 3, 6, 21, 4, 10, 484, DateTimeKind.Local).AddTicks(7003),
                            EmployeeJobId = 1,
                            ExtraTimeStop = new DateTime(2022, 3, 6, 21, 4, 10, 486, DateTimeKind.Local).AddTicks(9535),
                            StartShift = new DateTime(2022, 3, 6, 21, 4, 10, 486, DateTimeKind.Local).AddTicks(8036),
                            StopShift = new DateTime(2022, 3, 6, 21, 4, 10, 486, DateTimeKind.Local).AddTicks(8606)
                        });
                });
