...
namespace BilgeHotel.DataAccess.Migrations
{
    ...
    [Migration("20220306165152_adefe")]
    partial class adefe
    {
            ...
            modelBuilder.Entity("BilgeHotel.Entities.ComplexType.ReservationDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationId = new Guid("4631a5ee-89f6-4825-bcb4-5d7e7c27763c"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("87b239f2-b18d-42d8-8251-908a077019a4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 19, 51, 50, 822, DateTimeKind.Local).AddTicks(6882),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("7ba187a4-6251-43db-9acc-b668b2c19f2f"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("87b239f2-b18d-42d8-8251-908a077019a4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 19, 51, 50, 824, DateTimeKind.Local).AddTicks(3966),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("d9f7e52a-54e5-4f22-b43f-37759165fd8f"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("87b239f2-b18d-42d8-8251-908a077019a4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 19, 51, 50, 824, DateTimeKind.Local).AddTicks(3977),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("87b239f2-b18d-42d8-8251-908a077019a4"),
                            CardNumber = "selam",
                            CardType = "Ziraat",
                            Cv2 = "ABC",
                            EndDate = "02/05"
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4631a5ee-89f6-4825-bcb4-5d7e7c27763c"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("7ba187a4-6251-43db-9acc-b668b2c19f2f"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("d9f7e52a-54e5-4f22-b43f-37759165fd8f"),
                            CustomerId = 1
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Shift", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 3, 6, 19, 51, 50, 818, DateTimeKind.Local).AddTicks(5058),
                            EmployeeJobId = 1,
                            ExtraTimeStop = new DateTime(2022, 3, 6, 19, 51, 50, 821, DateTimeKind.Local).AddTicks(822),
                            StartShift = new DateTime(2022, 3, 6, 19, 51, 50, 820, DateTimeKind.Local).AddTicks(9211),
                            StopShift = new DateTime(2022, 3, 6, 19, 51, 50, 820, DateTimeKind.Local).AddTicks(9880)
                        });
                });
