            ...
            modelBuilder.Entity("BilgeHotel.Entities.ComplexType.ReservationDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationId = new Guid("ca786c38-07ae-4ca1-9b6a-e0ea243d325d"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("4ab2f3d9-edb1-47b7-aa7b-8f90ea1b0b10"),
                            ...
                            CreatedDate = new DateTime(2022, 2, 26, 19, 24, 31, 190, DateTimeKind.Local).AddTicks(2993),
                            Discount = 22.0,
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ab2f3d9-edb1-47b7-aa7b-8f90ea1b0b10"),
                            CardNumber = "selam",
                            CardType = "Ziraat",
                            Cv2 = "ABC",
                            EndDate = "02/05"
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ca786c38-07ae-4ca1-9b6a-e0ea243d325d"),
                            CustomerId = 1
                        });
                });
