...
namespace BilgeHotel.DataAccess.Migrations
{
    ...
    [Migration("20220306191204_bittisukur")]
    partial class bittisukur
    {
            ...
            modelBuilder.Entity("BilgeHotel.Entities.ComplexType.ReservationDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationId = new Guid("682aa588-63a9-4255-a2d5-6af0eaa66591"),
                            CardId = new Guid("b740f799-7eb7-4275-bd50-e459b98601c4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 22, 12, 2, 929, DateTimeKind.Local).AddTicks(1534),
                            Discount = 22.0,
                        ...
                        new
                        {
                            ReservationId = new Guid("90b65286-8768-45dc-8468-7228817c5bea"),
                            CardId = new Guid("b740f799-7eb7-4275-bd50-e459b98601c4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 22, 12, 2, 929, DateTimeKind.Local).AddTicks(3843),
                            Discount = 22.0,
                            DiscountedPrice = 150m,
                            PackageId = 1,
                            RoomId = 101
                        ...
                        new
                        {
                            ReservationId = new Guid("4ae0da74-76b0-4998-ba38-951c5a5b891e"),
                            CardId = new Guid("b740f799-7eb7-4275-bd50-e459b98601c4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 22, 12, 2, 929, DateTimeKind.Local).AddTicks(3850),
                            Discount = 22.0,
                            DiscountedPrice = 150m,
                            PackageId = 1,
                            RoomId = 101
                        ...
                        new
                        {
                            ReservationId = new Guid("77027110-748f-4b0d-aabc-58f022e9f8c9"),
                            CardId = new Guid("b740f799-7eb7-4275-bd50-e459b98601c4"),
                            CheckInDate = new DateTime(2022, 3, 6, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckOutDate = new DateTime(2022, 3, 7, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2022, 3, 6, 22, 12, 2, 929, DateTimeKind.Local).AddTicks(3855),
                            Discount = 22.0,
                            DiscountedPrice = 150m,
                            PackageId = 1,
                            RoomId = 102
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b740f799-7eb7-4275-bd50-e459b98601c4"),
                            CardNumber = "selam",
                            CardType = "Ziraat",
                            Cv2 = "ABC",
                            EndDate = "02/05"
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("682aa588-63a9-4255-a2d5-6af0eaa66591"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("90b65286-8768-45dc-8468-7228817c5bea"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("4ae0da74-76b0-4998-ba38-951c5a5b891e"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("77027110-748f-4b0d-aabc-58f022e9f8c9"),
                            CustomerId = 1,
                            EmployeeId = 4
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Shift", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 3, 6, 22, 12, 2, 926, DateTimeKind.Local).AddTicks(85),
                            EmployeeJobId = 4,
                            ExtraTimeStop = new DateTime(2022, 3, 6, 22, 12, 2, 927, DateTimeKind.Local).AddTicks(8472),
                            StartShift = new DateTime(2022, 3, 6, 22, 12, 2, 927, DateTimeKind.Local).AddTicks(7133),
                            StopShift = new DateTime(2022, 3, 6, 22, 12, 2, 927, DateTimeKind.Local).AddTicks(7634)
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.ShiftTime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StopTime = new TimeSpan(0, 8, 0, 0, 0)
                        },
                        new
                        {
                            Id = 2,
                            StartTime = new TimeSpan(0, 8, 0, 0, 0),
                            StopTime = new TimeSpan(0, 16, 0, 0, 0)
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            Id = 4,
                            StartTime = new TimeSpan(0, 8, 0, 0, 0),
                            StopTime = new TimeSpan(0, 18, 0, 0, 0)
                        });
                });
