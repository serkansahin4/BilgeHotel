...
namespace BilgeHotel.DataAccess.Migrations
{
    ...
    [Migration("20220306153222_asdhe")]
    partial class asdhe
    {
            ...
            modelBuilder.Entity("BilgeHotel.Entities.ComplexType.ReservationDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationId = new Guid("0446338e-f98a-4a3c-a597-a4508a85b277"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("fd93ea8e-0f47-4ef0-bb60-7d55470643d4"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 18, 32, 20, 851, DateTimeKind.Local).AddTicks(9276),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("da607d1e-fa54-4b7e-ac74-3b14d84a8cc0"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("fd93ea8e-0f47-4ef0-bb60-7d55470643d4"),
                            CheckInDate = new DateTime(2022, 4, 7, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckOutDate = new DateTime(2022, 4, 8, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2022, 3, 6, 18, 32, 20, 852, DateTimeKind.Local).AddTicks(1761),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fd93ea8e-0f47-4ef0-bb60-7d55470643d4"),
                            CardNumber = "selam",
                            CardType = "Ziraat",
                            Cv2 = "ABC",
                            EndDate = "02/05"
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0446338e-f98a-4a3c-a597-a4508a85b277"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("da607d1e-fa54-4b7e-ac74-3b14d84a8cc0"),
                            CustomerId = 1
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Shift", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 3, 6, 18, 32, 20, 848, DateTimeKind.Local).AddTicks(4057),
                            EmployeeJobId = 1,
                            ExtraTimeStop = new DateTime(2022, 3, 6, 18, 32, 20, 850, DateTimeKind.Local).AddTicks(5084),
                            StartShift = new DateTime(2022, 3, 6, 18, 32, 20, 850, DateTimeKind.Local).AddTicks(3466),
                            StopShift = new DateTime(2022, 3, 6, 18, 32, 20, 850, DateTimeKind.Local).AddTicks(4113)
                        });
                });
