            ...
            modelBuilder.Entity("BilgeHotel.Entities.ComplexType.ReservationDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReservationId = new Guid("270688d8-d738-48e1-94cf-025b73126809"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("a8ac33af-f174-44a6-97b1-2c04664fca2f"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 18, 43, 33, 418, DateTimeKind.Local).AddTicks(4871),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        },
                        new
                        {
                            ReservationId = new Guid("84a0df71-93a6-4675-837a-c894fb2208cc"),
                            PackageId = 1,
                            RoomId = 101,
                            CardId = new Guid("a8ac33af-f174-44a6-97b1-2c04664fca2f"),
                            ...
                            CreatedDate = new DateTime(2022, 3, 6, 18, 43, 33, 418, DateTimeKind.Local).AddTicks(8263),
                            Discount = 22.0,
                            DiscountedPrice = 150m
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Card", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8ac33af-f174-44a6-97b1-2c04664fca2f"),
                            CardNumber = "selam",
                            CardType = "Ziraat",
                            Cv2 = "ABC",
                            EndDate = "02/05"
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("270688d8-d738-48e1-94cf-025b73126809"),
                            CustomerId = 1
                        },
                        new
                        {
                            Id = new Guid("84a0df71-93a6-4675-837a-c894fb2208cc"),
                            CustomerId = 1
                        });
                });
            ...
            modelBuilder.Entity("BilgeHotel.Entities.Concrete.Shift", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 3, 6, 18, 43, 33, 413, DateTimeKind.Local).AddTicks(6763),
                            EmployeeJobId = 1,
                            ExtraTimeStop = new DateTime(2022, 3, 6, 18, 43, 33, 416, DateTimeKind.Local).AddTicks(3738),
                            StartShift = new DateTime(2022, 3, 6, 18, 43, 33, 416, DateTimeKind.Local).AddTicks(1814),
                            StopShift = new DateTime(2022, 3, 6, 18, 43, 33, 416, DateTimeKind.Local).AddTicks(2539)
                        });
                });
